...
@javax.annotation.Generated(
    ...
    comments = "Source: sec07/guess-game.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class GuessNumberGrpc {

  private GuessNumberGrpc() {}

  public static final java.lang.String SERVICE_NAME = "sec07.GuessNumber";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.models.sec07.GuessRequest,
      com.models.sec07.GuessResponse> getGuessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Guess",
      requestType = com.models.sec07.GuessRequest.class,
      responseType = com.models.sec07.GuessResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.models.sec07.GuessRequest,
      com.models.sec07.GuessResponse> getGuessMethod() {
    io.grpc.MethodDescriptor<com.models.sec07.GuessRequest, com.models.sec07.GuessResponse> getGuessMethod;
    if ((getGuessMethod = GuessNumberGrpc.getGuessMethod) == null) {
      synchronized (GuessNumberGrpc.class) {
        if ((getGuessMethod = GuessNumberGrpc.getGuessMethod) == null) {
          GuessNumberGrpc.getGuessMethod = getGuessMethod =
              io.grpc.MethodDescriptor.<com.models.sec07.GuessRequest, com.models.sec07.GuessResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Guess"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.models.sec07.GuessRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.models.sec07.GuessResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GuessNumberMethodDescriptorSupplier("Guess"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.models.sec07.GuessRequest> guess(
        io.grpc.stub.StreamObserver<com.models.sec07.GuessResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getGuessMethod(), responseObserver);
    }
  }
  ...
  public static final class GuessNumberStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.models.sec07.GuessRequest> guess(
        io.grpc.stub.StreamObserver<com.models.sec07.GuessResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.models.sec07.GuessRequest,
              com.models.sec07.GuessResponse>(
                service, METHODID_GUESS)))
        .build();
  }
  ...
  private static abstract class GuessNumberBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.models.sec07.GuessGame.getDescriptor();
    }
